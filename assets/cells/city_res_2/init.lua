...
local modelFile = "assets/cells/city_res_2/model.obj"

local model = g3d.newModel(modelFile, "assets/cells/city_res_2/texture.png")
local plane = g3d.newModel("assets/cells/plane.obj", "assets/cells/city_res_2/plane.png")
